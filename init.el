...
")
 ...
 '(warning-suppress-log-types
   '(((package reinitialization))
     ...
     (comp)
     (comp)))
 '(warning-suppress-types '(((package reinitialization)) (comp) (comp)))
...
(custom-set-faces
 ...
 '(company-preview ((t (:background "gray30" :foreground "gray10"))))
